...
* přidáno 13 nových parametrů pro verzi 4.7 (překládáno průběžně, stále se k těmto parametrům musí přistupovat jako k placeholderům)
* aktualizovány 2 popisky u parametrů pro verzi 4.7 (originál byl změněn)
