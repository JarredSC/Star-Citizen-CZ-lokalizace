...
[![Static Badge](https://img.shields.io/badge/PTU%204.10.1-brightgreen?style=for-the-badge&color=232323)![Static Badge](https://img.shields.io/badge/✔-%234cc71e?style=for-the-badge&labelColor=232323%20)](#)
[![Static Badge](https://img.shields.io/badge/LIVE%204.10-brightgreen?style=for-the-badge&color=232323)![Static Badge](https://img.shields.io/badge/✔-%234cc71e?style=for-the-badge&labelColor=232323%20)](#)
...
* přidáno 22 nových parametrů pro verzi 4.10.1 (překládáno průběžně, stále se k těmto parametrům musí přistupovat jako k placeholderům)
* odstraněno 360 smazaných parametrů pro verzi 4.9 (parametry, které vývojáři odebrali z lokalizačního souboru)
* opravy nahlášených chyb

### v0.9ap | 22-08-2026

* přidáno 71 nových parametrů pro verzi 4.10 (překládáno průběžně, stále se k těmto parametrům musí přistupovat jako k placeholderům)
* opravy nahlášených chyb

### v0.9ao | 30-07-26

* přidáno 221 nových parametrů pro verzi 4.10 (překládáno průběžně, stále se k těmto parametrům musí přistupovat jako k placeholderům)
* opravy nahlášených chyb
...
* přidáno 53 nových parametrů pro verzi 4.9 (překládáno průběžně, stále se k těmto parametrům musí přistupovat jako k placeholderům)
* aktualizováno 49 parametrů pro verzi 4.9 (texty parametrů, které vývojáři aktualizovali v lokalizačním souboru)

### v0.9al | 07-07-26

* přidáno 74 nových parametrů pro verzi 4.9 (překládáno průběžně, stále se k těmto parametrům musí přistupovat jako k placeholderům)
* aktualizováno 32 parametrů pro verzi 4.9 (texty parametrů, které vývojáři aktualizovali v lokalizačním souboru)

### v0.9ak | 03-07-26

* přidáno 69 nových parametrů pro verzi 4.9 (většinou se jedná o nahrazení placeholderů)
...
* odstraněno 5 smazaných parametrů pro verzi 4.9 (parametry, které vývojáři odebrali z lokalizačního souboru)
* opravy nahlášených chyb
...
* přidáno 101 nových parametrů pro verzi 4.9 (překládáno průběžně, stále se k těmto parametrům musí přistupovat jako k placeholderům)

### v0.9ai | 01-07-26

* přidáno 49 nových parametrů pro verzi 4.8.3 (překládáno průběžně, stále se k těmto parametrům musí přistupovat jako k placeholderům)
...
* přidáno 986 nových parametrů pro verzi 4.9 (překládáno průběžně, stále se k těmto parametrům musí přistupovat jako k placeholderům)
* opravy nahlášených chyb

### v0.9ae | 18-06-2026

* přidáno 62 nových parametrů pro verzi 4.8.2
* přeloženy nové skiny pro Gatac a Tyilui
* přeloženy texty k převodu měny mezi hráči
* opravy nahlášených chyb
...
* přidáno 5 nových parametrů pro verzi 4.8

### v0.9ab | 14-05-2026

* přidáno 21 nových parametrů pro verzi 4.8
* odstraněno 209 smazaných parametrů (parametry, které vývojáři odebrali z lokalizačního souboru)
* aktualizováno 236 parametrů (texty parametrů, které vývojáři aktualizovali v lokalizačním souboru)
  * včetně velké aktualizace "A Forager's Guide" (Sběračova průvodce), který naleznete ve svém Deníku.
* opravy nahlášených chyb

### v0.9aa | 10-05-2026

* přidáno 424 nových parametrů pro verzi 4.8 (překládáno průběžně, stále se k těmto parametrům musí přistupovat jako k placeholderům)
* opravy nahlášených chyb

### v0.9z | 01-05-2026

* přidáno 141 nových parametrů pro verzi 4.8 (překládáno průběžně, stále se k těmto parametrům musí přistupovat jako k placeholderům)
* opravy nahlášených chyb

### v0.9y | 29-04-2026

* přidáno 23 nových parametrů pro verzi 4.8 (překládáno průběžně, stále se k těmto parametrům musí přistupovat jako k placeholderům)

### v0.9x | 28-04-2026

* přidáno 184 nových parametrů pro verzi 4.8 (překládáno průběžně, stále se k těmto parametrům musí přistupovat jako k placeholderům)
* opravy nahlášených chyb
...
* přidáno 35 nových parametrů pro verzi 4.7.1
...
* přidáno 77 nových parametrů pro verzi 4.7
* aktualizovány 2 parametry pro verzi 4.7 (originál byl změněn)
* přeloženo 116 parametrů pro fabrikátor
* přeložen březnový newsletter Vox Populi (naleznete v Journalu/Deníku)
* opravy nahlášených chyb
